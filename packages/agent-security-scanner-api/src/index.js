/**
 * agent-security-scanner-api - Package 2: api for AI Security Scanner
 * Project: agent-security-scanner
 */
export class AgentSecurityScannerApi {
  constructor(options = {}) {
    this.name = 'agent-security-scanner-api';
...
export default AgentSecurityScannerApi;
